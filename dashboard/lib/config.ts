...
/**
 * Parse vigil.yml into a typed config object.
 */
export function parseConfig(raw: string): VigilConfig {
...
/**
 * Update a skill's config fields in vigil.yml. Preserves formatting and comments.
 */
...
/**
 * Remove a skill entry from vigil.yml.
 */
...
/**
 * Add a new skill entry to vigil.yml (before the fallback comment).
 */
