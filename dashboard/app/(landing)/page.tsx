...
const DOWNLOADS: { platform: string; arch: string; Icon: React.FC<{ size?: number }>; url: string; ext: string }[] = [
  {
    ...
    arch: 'Apple Silicon',
    Icon: AppleIcon,
    url: `${RELEASES_BASE}/Vigil-macOS-arm64.dmg`,
    ext: '.dmg',
  },
  {
    platform: 'macOS',
    arch: 'Intel',
    Icon: AppleIcon,
    url: `${RELEASES_BASE}/Vigil-macOS-x64.dmg`,
    ext: '.dmg',
  },
  {
    platform: 'Windows',
    arch: '64-bit',
    Icon: WindowsIcon,
    url: `${RELEASES_BASE}/Vigil-Windows-x64.exe`,
    ext: '.exe',
  },
  {
    platform: 'Linux',
    arch: 'x64',
    Icon: LinuxIcon,
    url: `${RELEASES_BASE}/Vigil-Linux-x64.AppImage`,
    ext: '.AppImage',
  },
]
