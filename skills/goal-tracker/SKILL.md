...
- **AT RISK** with `days_since_last_activity > 21` → name a specific Vigil skill to enable, a concrete commit, or a file to create (e.g., "Enable `rss-digest` in vigil.yml to produce the weekly digest evidence").
