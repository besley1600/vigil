---
name: Channel Recap
description: Weekly recap from a public Telegram channel — engagement-ranked posts expanded into a coherent narrative article
var: ""
tags: [content]
---
<!-- autoresearch: variation A — engagement-weighted selection using t.me/s/ view + reaction signal -->

> **${var}** — Telegram channel username (without @). Required — set in vigil.yml var field.
