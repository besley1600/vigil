...
- Good: "besley1600/vigil is pivoting from scheduled digests to reactive skill chains — 4 of 7 merged PRs this week added or consumed `.outputs/*.md` contracts."
- Bad: "Vigil is an interesting agent framework." (not falsifiable)
