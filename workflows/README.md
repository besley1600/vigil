...
Each template wraps one of Vigil's battle-tested skills as a portable `.md` workflow that any repo can use — no need to fork or install the full Vigil agent.
...
1. Copy any `.md` file into your repo's `.github/workflows/` directory:
   ...
   curl -O https://raw.githubusercontent.com/besley1600/vigil/main/workflows/pr-review.md
...
These templates are adapted from Vigil's internal skills. The full skills include memory integration, multi-repo support, notification channels, and dashboard rendering. If you want the full experience, [set up Vigil](../README.md#quick-start) instead.
