...
Visual map of all 91+ Vigil skills grouped by category, with dependency edges showing how skills connect.
...
The most important dependency chain in Vigil. Five skills form a closed loop that detects, diagnoses, and fixes problems without human intervention:
